...
const userController = {
    ...
    search:controllerHandler(requireAuth(userService.searchUsers, [roles.ADMIN, roles.MODERATOR])),
    ...
    userProfile: controllerHandler(requireAuth(userService.userProfile, [roles.USER]))
}
